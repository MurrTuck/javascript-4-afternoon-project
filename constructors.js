...
const newCar = new CarFactory('Constructor', 'Fuction')
console.log(newCar)
...
User.prototype.removeSavedPost = function (id) {
  let index = this.savedPosts.findIndex(posts => id === posts.id)
...
User.prototype.changePostRating = function (id, newRating) {
  let index = this.savedPosts.findIndex(post => id === post.id);
